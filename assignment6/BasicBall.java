/******************************************************************************
 *  Compilation:  javac BasicBall.java
 *  Execution:    java BasicBall
 ...
 ******************************************************************************/
 ...
 public class BasicBall { 
     ...
     public int reset() {
         rx = 0.0;
         ry = 0.0;  	
         vx = StdRandom.uniform(-0.03, 0.03); // assign a random speed in x direction
         vy = StdRandom.uniform(-0.03, 0.03); // assign a random speed in y direction
         return 1;
     }
